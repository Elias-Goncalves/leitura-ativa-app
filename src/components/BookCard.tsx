...
import ReadingSuggestions from './ReadingSuggestions';
...
export default function BookCard({ book }: BookCardProps) {
  ...
  return (
    <div>
      ...
      {/* Sugestões de leitura aparecem apenas quando o livro está concluído */}
      {isCompleted && <ReadingSuggestions completedBook={book} />}
    </div>
  );
}
